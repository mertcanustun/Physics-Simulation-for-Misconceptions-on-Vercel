...
@export_range(1.0, 20.0, 0.01, "suffix:m/s^2") var gravity_g: float = 9.81
@export_range(0.0, 0.1, 0.001, "suffix:kg/m") var drag_k: float = 0.025          ## hava direnci katsayısı
@export_range(0.0, 40.0, 0.5, "suffix:m/s^2") var impetus_acc: float = 15.0       ## "vuruş kuvveti F" yanılgısının büyüklüğü
...
@export_range(0.2, 3.0, 0.05, "suffix:x") var mass_kg: float = 1.0
...
@export_range(0.0, 20.0, 0.1, "suffix:m/s^2") var roll_friction: float = 6.5   ## yuvarlanma sürtünmesi
...
@export_range(1.0, 30.0, 0.1, "suffix:px per m/s^2") var arrow_scale: float = 7.2   ## okların uzunluk ölçeği
@export_range(20.0, 400.0, 5.0, "suffix:px") var arrow_max_px: float = 150.0       ## ok en fazla bu kadar uzayabilir
@export_range(0.3, 3.0, 0.05, "suffix:x") var arrow_head_ratio: float = 1.0        ## ok ucu / gövde oranı
...
@export_group("Kamera")
@export_range(0.5, 3.0, 0.05, "suffix:x") var camera_start_zoom: float = 1.55  ## uçuş başındaki yakınlık
@export_range(0.05, 1.0, 0.01, "suffix:x") var camera_min_zoom: float = 0.16   ## en uzak (top ekrandan taşmasın)
@export_range(0.2, 2.0, 0.05, "suffix:x") var camera_max_zoom: float = 1.0     ## en yakın
