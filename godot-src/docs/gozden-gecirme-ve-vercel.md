...
- `not rolling` koşulu: eski `vel.length() > 0.01` koruması hız-yönlü model
  içindi; sabit yönde o koruma yetmez - yerde durmuş topu 45 derece yukarı itip
...
Sabit yönlü F ile davranış büyüklüğe göre keskin değişir (v0=30, 45 derece, kütle 1):

| impetus_acc | g+F sonucu |
|---|---|
| > 13.87 (= g/sin45 derece) | dikey net ivme YUKARI -> top hiç inmez, uzaya çıkar |
