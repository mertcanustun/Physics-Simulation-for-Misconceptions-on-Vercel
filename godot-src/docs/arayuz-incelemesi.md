...
| Kalıp | Bizde durum |
|---|---|
| Play/Pause/Reset | VAR alt çubukta (Vuruşu başlat / Durdur / Sıfırla) |
| Yavaşlatma | VAR 0.25x - 2x |
| Kuvvet vektörleri | VAR yalnızca seçilen kuvvet, büyüklükle orantılı |
| Katmanlı gösterim | ~ kısmi: hız/vy HUD'da sabit açık |
| Hayalet/karşılaştırma izi | VAR kesikli gerçek yol + soluk top |
| Doğrudan manipülasyon | YOK (bilinçli tercih: açı/kuvvet sabit, deneysel kontrol) |
